...
<p align="center" width="100%">
    <img width="60%" src="mlops_certification.png">
</p>
...
During the program, we completed four courses with four projects ([Certification](https://confirm.udacity.com/K6YJFENE)).
